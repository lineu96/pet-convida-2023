...
## Preditores iniciais
 ...
 - Nas distribuições com parâmetros associados à inflação de zeros foram incluídos os efeitos fixos de sessão, momento e linhagem.

## Seleção de modelos

 - A distribuição foi selecionada por meio de medidas de qualidade de ajuste.
 ...
 - Buscou-se o menor modelo que não diferisse do original.
    ...
    - A comparação entre o modelo original e os reduzidos foi feito por meio do teste da razão de verossimilhanças.
